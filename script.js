...
function updateCartCount() {
  ...
  if (countElement) {
    countElement.textContent = cart.reduce((total, item) => total + item.quantity, 0); // Soma todas as quantidades
  }
  
  // Atualiza o contador em outros locais (como no header do index.html)
